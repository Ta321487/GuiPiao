...
public partial class AutoCompleteTextBox : UserControl
{
    ...
    public static readonly DependencyProperty SuggestionsProperty =
        DependencyProperty.Register(nameof(Suggestions), typeof(ObservableCollection<string>),
    ...
    {
        if (sender is ListBox listBox && listBox.SelectedItem is string selected) SelectItem(selected);
    }
