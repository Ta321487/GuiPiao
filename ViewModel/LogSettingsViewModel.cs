...
namespace GuiPiao.ViewModel
{
    public partial class LogSettingsViewModel : ObservableObject, ISettingsViewModel
    {
        ...
        [ObservableProperty]
        private string _currentLogFileSize;
        ...
        private async Task SaveSettingsInternalAsync(bool showMessage)
        {
            ...
            try
            {
                ...
                if (AutoCleanup)
                {
                    await _logService.AutoCleanupAsync();
                }
                ...
                if (showMessage)
                {
                    MessageBoxWindow.Show(owner, "设置已保存", "成功", MessageBoxButton.OK, MessageBoxImage.Information);
                }
            }
            catch (Exception ex)
            {
        ...
        private void OpenLogFolder()
        {
            ...
            try
            {
                string logDir = _logService.GetLogDirectory();
                ...
                {
                    MessageBoxWindow.Show(owner, "日志文件夹不存在", "提示", MessageBoxButton.OK, MessageBoxImage.Information);
                }
            }
            catch (Exception ex)
            {
