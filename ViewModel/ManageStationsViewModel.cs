    ...
    public partial class ManageStationsViewModel : ObservableObject
    {
        ...
        private async Task SaveStationAsync()
        {
            ...
            if (existingStation != null)
            {
                ...
                try
                {
                    ...
                    MessageBoxWindow.Show("车站信息更新成功", "提示", MessageBoxButton.OK, MessageBoxImage.Information);
                    LoadAllStationsAsync();
                    ClearFields();
                }
            ...
            else
            {
                ...
                try
                {
                    ...
                    MessageBoxWindow.Show("车站添加成功", "提示", MessageBoxButton.OK, MessageBoxImage.Information);
        ...
        private async Task DeleteStationAsync(StationInfo station)
        {
            ...
            try
            {
                ...
                MessageBoxWindow.Show("车站删除成功", "提示", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (System.Exception ex)
            {
