...
namespace GuiPiao.ViewModel
{
    ...
    /// 编辑火车票 ViewModel
    /// </summary>
    public partial class EditTrainTicketViewModel : TrainTicketFormViewModelBase
    {
        ...
        protected override async Task ExecuteSaveAsync()
        {
            ...
            _logService.Info("EditTrainTicketViewModel", $"保存前: EditTicketId={EditTicketId.Value}, DepartTimeValue={DepartTimeValue}, DepartTime='{DepartTime}'");
            
            var trainRide = CreateTrainRideInfo();
            _logService.Info("EditTrainTicketViewModel", $"保存数据: ID={trainRide.Id}, TrainNo={trainRide.TrainNo}, DepartStation={trainRide.DepartStation}, ArriveStation={trainRide.ArriveStation}");
