...
namespace GuiPiao.ViewModel.TrainTicketForm
{
    ...
    {
        // 车次号前缀选项
        public ObservableCollection<string> TrainNoPrefixes { get; } = new ObservableCollection<string>
        {
            "G", "C", "D", "Z", "T", "K", "L", "S", "纯数字"
        };

        // 席别选项
        public ObservableCollection<string> SeatTypeOptions { get; } = new ObservableCollection<string>
        {
            "新空调硬座", "软座", "新空调硬卧", "新空调软卧", "商务座", "特等座", "一等座", "二等座", "硬卧代硬座"
        };

        // 座位字母选项
        public ObservableCollection<string> SeatLetterOptions { get; } = new ObservableCollection<string>();

        // 铺位选项（硬卧）
        public ObservableCollection<string> HardSleeperOptions { get; } = new ObservableCollection<string>
        {
            "上铺", "中铺", "下铺"
        };

        // 铺位选项（软卧）
        public ObservableCollection<string> SoftSleeperOptions { get; } = new ObservableCollection<string>
        {
            "上铺", "下铺"
        };

        // 附加信息选项
        public ObservableCollection<string> AdditionalInfoOptions { get; } = new ObservableCollection<string>
        {
            "", "限乘当日当次车", "退票费"
        };

        // 车票用途选项
        public ObservableCollection<string> TicketPurposeOptions { get; } = new ObservableCollection<string>
        {
            "", "仅供报销使用"
        };

        // 改签类型选项
        public ObservableCollection<string> TicketModificationTypeOptions { get; } = new ObservableCollection<string>
        {
            "", "始发改签", "变更到站"
        };
        ...
        // 提示信息选项
        private List<string> _hintOptions = new List<string>
        {
            "",
        ...
        public ObservableCollection<string> HintOptions { get; } = new ObservableCollection<string>();

        public OptionsProvider()
        {
            foreach (var hint in _hintOptions)
            {
        ...
        /// 更新车票用途选项（根据附加信息）
        /// </summary>
        public void UpdateTicketPurposeOptions(string additionalInfo, ObservableCollection<string> ticketPurposeOptions, string currentTicketPurpose)
        {
            // 计算新的选项列表
        ...
        /// 更新附加信息选项（根据车票用途）
        /// </summary>
        public void UpdateAdditionalInfoOptions(string ticketPurpose, ObservableCollection<string> additionalInfoOptions, string currentAdditionalInfo)
        {
            // 计算新的选项列表
            var newOptions = new List<string>();
