...
public class DataGridColumnConfig
{
    ...
    public static List<DataGridColumnConfig> GetDefaultColumns()
    {
        return new List<DataGridColumnConfig>
        {
            new()
            {
                FieldName = "Id", Header = "序号", IsVisible = true, DisplayOrder = 0, Width = "50", MinWidth = 50,
                CanSort = true, IsReadOnly = true
            },
            new()
            {
                FieldName = "TrainNo", Header = "车次", IsVisible = true, DisplayOrder = 1, Width = "80", MinWidth = 80,
                CanSort = true, IsReadOnly = true
            },
            new()
            {
                FieldName = "DepartStation", Header = "出发站", IsVisible = true, DisplayOrder = 2, Width = "100",
                MinWidth = 100, CanSort = true, IsReadOnly = true
            },
            new()
            {
                FieldName = "ArriveStation", Header = "到达站", IsVisible = true, DisplayOrder = 3, Width = "100",
                MinWidth = 100, CanSort = true, IsReadOnly = true
            },
            new()
            {
                FieldName = "DepartDate", Header = "出发日期", IsVisible = true, DisplayOrder = 4, Width = "95",
                MinWidth = 95, CanSort = true, IsReadOnly = true
            },
            new()
            {
                FieldName = "DepartTime", Header = "出发时间", IsVisible = true, DisplayOrder = 5, Width = "75",
                MinWidth = 75, CanSort = true, IsReadOnly = true
            },
            new()
            {
