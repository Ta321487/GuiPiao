...
namespace GuiPiao.View
{
    public partial class AddTrainTicketWindow : Window
    {
        ...
        private bool _isUndoRedoMessageRegistered = false;
        ...
        /// 创建改签窗口
        /// </summary>
        public static AddTrainTicketWindow CreateRescheduleWindow(string departStation, string arriveStation, bool isChangeDestination)
        {
        ...
        private async void OnWindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                viewModel.SkipLoadDefaults = true;
            }
            ...
            if (_isRescheduleMode)
            {
                ...
                await viewModel.ApplyRescheduleDataAsync(_rescheduleDepartStation ?? string.Empty, _rescheduleArriveStation ?? string.Empty, _isRescheduleChangeDestination);
            }
            ...
            if (!_isUndoRedoMessageRegistered)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("[AddTrainTicketWindow] 收到 UndoRedoSettingsChangedMessage");
                    if (this.DataContext is TrainTicketFormViewModelBase vm)
                    {
                        vm.RefreshUndoRedoSettings();
                    }
                });
                _isUndoRedoMessageRegistered = true;
                System.Diagnostics.Debug.WriteLine("[AddTrainTicketWindow] 已订阅 UndoRedoSettingsChangedMessage");
            }
        ...
        private void OnWindowClosing(object? sender, CancelEventArgs e)
        {
            ...
            if (this.DataContext is not TrainTicketFormViewModelBase vm)
            {
                return;
            }
