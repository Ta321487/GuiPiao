...
namespace GuiPiao.View
{
    ...
    public partial class MapWindow : Window
    {
            ...
            try
            {
                ...
                if (MapWebView != null)
                {
                    try
                    {
                        ...
                        if (MapWebView.CoreWebView2 != null)
                        {
                            MapWebView.CoreWebView2.Navigate("about:blank");
                        }
                    }
                    catch { }
                ...
                System.Diagnostics.Debug.WriteLine("[MapWindow] 资源清理完成");
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"[MapWindow] 清理过程中发生错误: {ex.Message}");
            }
        }
        ...
        private void CoreWebView2_NavigationStarting(object? sender, CoreWebView2NavigationStartingEventArgs e)
        {
            ...
            // 允许本地地图HTML文件加载
            if (uri == mapHtmlUri || uri.StartsWith("file://") && uri.EndsWith("map.html"))
            {
                return; // 允许导航
            }
            ...
            // 禁止所有其他导航（包括点击链接）
            e.Cancel = true;
            System.Diagnostics.Debug.WriteLine($"已阻止导航到：{e.Uri}");
        }
        ...
        private void CoreWebView2_WebMessageReceived(object? sender, CoreWebView2WebMessageReceivedEventArgs e)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"处理Web消息失败：{ex.Message}");
            }
        }
        ...
        private void HandleWebMessage(string message)
        {
            try
            {
                ...
                switch (msgData.Type)
                {
                    case "stationClick":
                        ...
                        Dispatcher.Invoke(() =>
                        {
                            _viewModel?.OnStationClick(stationName);
                        });
                        break;
                    ...
                    case "error":
                        ...
                        Dispatcher.Invoke(() =>
                        {
                            if (_viewModel != null)
                            {
                                _viewModel.StatusMessage = $"地图错误：{errorMsg}";
                            }
                        });
                        break;
                    ...
                    case "openTicketEdit":
                        ...
                        Dispatcher.Invoke(() =>
                        {
                            _viewModel?.OpenTicketEdit(editTripId);
                        });
                        break;
                    ...
                    case "showTicketDetails":
                        ...
                        Dispatcher.Invoke(() =>
                        {
                            _viewModel?.ShowTicketDetails(detailsTripId);
                        });
                        break;
                    ...
                    case "showStationTickets":
                        ...
                        Dispatcher.Invoke(() =>
                        {
                            _viewModel?.ShowStationTickets(dblClickStationName);
                        });
                        break;
                    ...
                    case "previewTicket":
                        ...
                        Dispatcher.Invoke(() =>
                        {
                            _viewModel?.PreviewTicket(previewTripId);
                        });
                        break;
                    ...
                    case "showStationStats":
                        ...
                        Dispatcher.Invoke(() =>
                        {
                            _viewModel?.ShowStationStats(statsStationName);
                        });
                        break;
                    ...
                    case "createTicketFromStation":
                        ...
                        Dispatcher.Invoke(() =>
                        {
                            _viewModel?.CreateTicketFromStation(createFromStationName);
                        });
                        break;
            ...
            {
                System.Diagnostics.Debug.WriteLine($"处理消息失败：{ex.Message}");
            }
        }
        ...
        private void MapWebView_NavigationCompleted(object sender, Microsoft.Web.WebView2.Core.CoreWebView2NavigationCompletedEventArgs e)
        {
            ...
            else
            {
                if (_viewModel != null)
                {
                    _viewModel.StatusMessage = $"地图加载失败：{e.WebErrorStatus}";
                }
            }
        }
