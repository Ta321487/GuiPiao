...
namespace GuiPiao.Services
{
    ...
    public static class ThemeManager
    {
        ...
        public static void ApplyDpiScaling(string dpiScaling)
        {
            ...
            Application.Current.Resources["DpiScaleTransform"] = new System.Windows.Media.ScaleTransform(_currentDpiScale, _currentDpiScale);
        ...
        public static bool IsSystemDarkMode()
        {
            try
            {
                ...
                if (key != null)
                {
                    ...
                    {
                        return intValue == 0; // 0 = 深色模式, 1 = 浅色模式
                    }
                }
            }
            catch
        ...
        {
            string colorHex = accentColor switch
            {
        ...
        private static void ApplyFontSize(FontSizeOption fontSize)
        {
            ...
            // 根据字体大小调整行高和控件尺寸
            double rowHeightMultiplier = fontSize switch
            {
        ...
        private static void UpdateLiveChartsTooltipFontSize(double fontSize)
        {
            ...
            {
                // 记录日志但不影响其他功能
                System.Diagnostics.Debug.WriteLine($"[ThemeManager] 更新 LiveCharts Tooltip 字体大小失败: {ex.Message}");
            }
        }
