            ...
            try
            {
                ...
                using (var writer = new StreamWriter(filePath))
                {
                    ...
                    while (true)
                    {
                        ...
                        {
                            writer.WriteLine($"{ride.TicketNumber},{ride.CheckInLocation},{ride.DepartStation},{ride.TrainNo},{ride.ArriveStation},{ride.DepartDate},{ride.DepartTime},{ride.CoachNo},{ride.SeatNo},{ride.Money},{ride.SeatType}");
                        }
